...
import { ChevronDown, ChevronUp, MoreHorizontal, Plus, SquareTerminal, X } from "lucide-react";
...
function formatTerminalTabLabel(tab: TerminalTab) {
					...
					{tabs.map((tab) => (
						...
						>
							...
							>
								...
								<span>{formatTerminalTabLabel(tab)}</span>
