...
export function SettingsModal(props: {
	...
	renderConfigPanel?: (group: "models" | "extensions" | "other") => ReactNode;
}) {
	...
	const tabs: Array<{
		...
		},
		{
			...
			description: t("settings.tabs.modelsDesc"),
			icon: <FileText size={16} />,
		},
		{
			id: "extensions",
			label: t("settings.tabs.extensions"),
			description: t("settings.tabs.extensionsDesc"),
			icon: <Plus size={16} />,
		},
		{
			id: "other",
			...
			>
				...
				<div className="settings-layout">
					...
					<div className="settings-panel">
						...
						{activeTab === "models" && props.renderConfigPanel?.("models")}
						{activeTab === "extensions" && props.renderConfigPanel?.("extensions")}
						{activeTab === "other" && props.renderConfigPanel?.("other")}
...
type SettingsTabId = "base" | "proxy" | "dev" | "models" | "extensions" | "other";
